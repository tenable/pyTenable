...
[1.9.1]: https://github.com/tenable/pyTenable/compare/1.9.0...1.9.1

## [1.9.0]

### Removed

- Removed Deprecated Access Groups endpoints and associated tests
- Removed Deprecated Access Groups v2 endpoints and associated tests
- Removed Deprecated Target Groups endpoints and associated tests

### Changed

- Removed unnecessary sleep timers from testing suite (sped up by 300%)
- Added pip security issue GHSA-4xh5-x5gv-qwph to pip-audit ignore as we aren't using anywhere but to actually run pip-audit. #965

### Updated

- Refactored the Exports API to use Pydantic instead of Marshmallow. Part of the longer effort to remove marshmallow
  from the library entirely and migrate to Pydantic v2. #968
- Refactored the base GQL library to support the gql v4 library as it's base #969

### Added

- Added support for PCI-ASV API endpoints within TVM. #971
- Added support for T1 Export Job improvements #970, #963, #966

[1.9.0]: https://github.com/tenable/pyTenable/compare/1.8.4...1.9.0
