...
- Pinned Marshmallow to <4 (Backported from 1.7.5) #911

## [1.6.2]

### Added

- ASM metadata field added to default response (Backported from 1.7.4) #894
- ASM API changes/improvements (Backported from 1.7.4) #891
- Updated export sub-pkg w/ API changes for asset v2 (Backported from 1.7.4) #889
- Updated export sub-pkg to support backwards compat to 1.4.x (Backported from 1.7.4) #890

### Changed

- Updated the RTD config to use UV (Backported from 1.7.4) #892
