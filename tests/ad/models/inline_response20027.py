...
class InlineResponse20027(object):
    ...
    def __init__(self, id=None, name=None, login=None):
    ...
    @property
    def id(self):
        """Gets the id of this InlineResponse20027.   


        :return: The id of this InlineResponse20027.   
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this InlineResponse20027.   
        :type: int
        """
        if id is None:
    ...
    @property
    def login(self):
        """Gets the login of this InlineResponse20027.   


        :return: The login of this InlineResponse20027.   
        :rtype: str
        """
        return self._login
    ...
    def login(self, login):
        """Sets the login of this InlineResponse20027.


        :param login: The login of this InlineResponse20027.   
        :type: str
        """
        if login is None:
