...
class InlineResponse20017(object):
    ...
    def __init__(self, id=None, codename=None, profile_id=None, checker_id=None, directory_id=None, value=None,
                 value_type=None, name=None, description=None, translations=None, staged=None):
