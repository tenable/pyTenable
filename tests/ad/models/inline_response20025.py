...
class InlineResponse20025(object):
    ...
    def __init__(self, id=None, ad_object_id=None, ad_object_type=None, directory_id=None, type=None,
                 event_provider_id=None, event_provider_uid=None, event_provider_date=None, _date=None):
