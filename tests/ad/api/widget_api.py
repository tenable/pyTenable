...
class WidgetApi(object):
    ...
    def api_dashboards_dashboard_id_widgets_id_delete(self, x_api_key, id, dashboard_id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_dashboards_dashboard_id_widgets_id_delete_with_http_info(x_api_key, id, dashboard_id,
                                                                                     **kwargs)
        else:
            (data) = self.api_dashboards_dashboard_id_widgets_id_delete_with_http_info(x_api_key, id, dashboard_id,
                                                                                       **kwargs)
            return data
    ...
    def api_dashboards_dashboard_id_widgets_id_get(self, x_api_key, dashboard_id, id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.api_dashboards_dashboard_id_widgets_id_get_with_http_info(x_api_key, dashboard_id, id,
                                                                                    **kwargs)
            return data
    ...
    def api_dashboards_dashboard_id_widgets_id_options_get(self, x_api_key, dashboard_id, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_dashboards_dashboard_id_widgets_id_options_get_with_http_info(x_api_key, dashboard_id, id,
                                                                                          **kwargs)
        else:
            (data) = self.api_dashboards_dashboard_id_widgets_id_options_get_with_http_info(x_api_key, dashboard_id, id,
                                                                                            **kwargs)
            return data
    ...
    def api_dashboards_dashboard_id_widgets_id_options_put(self, body, x_api_key, dashboard_id, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_dashboards_dashboard_id_widgets_id_options_put_with_http_info(body, x_api_key, dashboard_id,
                                                                                          id, **kwargs)
        else:
            (data) = self.api_dashboards_dashboard_id_widgets_id_options_put_with_http_info(body, x_api_key,
    ...
    def api_dashboards_dashboard_id_widgets_id_patch(self, body, x_api_key, dashboard_id, id, **kwargs):
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_dashboards_dashboard_id_widgets_id_patch_with_http_info(body, x_api_key, dashboard_id, id,
                                                                                    **kwargs)
        else:
            (data) = self.api_dashboards_dashboard_id_widgets_id_patch_with_http_info(body, x_api_key, dashboard_id, id,
                                                                                      **kwargs)
            return data
    ...
    def api_dashboards_dashboard_id_widgets_post(self, body, x_api_key, dashboard_id, **kwargs):
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.api_dashboards_dashboard_id_widgets_post_with_http_info(body, x_api_key, dashboard_id,
                                                                                  **kwargs)
            return data
