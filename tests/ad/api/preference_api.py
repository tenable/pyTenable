...
class PreferenceApi(object):
    ...
    def api_preferences_get(self, x_api_key, **kwargs):
        ...
        >>> thread = api.api_preferences_get(x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_preferences_get_with_http_info(x_api_key, **kwargs)
        else:
            (data) = self.api_preferences_get_with_http_info(x_api_key, **kwargs)
            return data
    ...
    def api_preferences_get_with_http_info(self, x_api_key, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_preferences_get_with_http_info(x_api_key, async_req=True)
        >>> result = thread.get()
    ...
    def api_preferences_patch(self, body, x_api_key, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_preferences_patch(body, x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_preferences_patch_with_http_info(body, x_api_key, **kwargs)
        else:
            (data) = self.api_preferences_patch_with_http_info(body, x_api_key, **kwargs)
            return data
    ...
    def api_preferences_patch_with_http_info(self, body, x_api_key, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_preferences_patch_with_http_info(body, x_api_key, async_req=True)
        >>> result = thread.get()
