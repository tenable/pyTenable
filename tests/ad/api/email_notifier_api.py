...
class EmailNotifierApi(object):
    ...
    def api_email_notifiers_test_message_id_get_with_http_info(self, x_api_key, id, **kwargs):
        ...
        if ('x_api_key' not in params or
                params['x_api_key'] is None):
            raise ValueError("Missing the required parameter `x_api_key` when calling `api_email_notifiers_test_message_id_get`")
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `api_email_notifiers_test_message_id_get`")
    ...
    def api_email_notifiers_test_message_post_with_http_info(self, body, x_api_key, **kwargs):
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `api_email_notifiers_test_message_post`")
        # verify the required parameter 'x_api_key' is set
        if ('x_api_key' not in params or
                params['x_api_key'] is None):
            raise ValueError("Missing the required parameter `x_api_key` when calling `api_email_notifiers_test_message_post`")
