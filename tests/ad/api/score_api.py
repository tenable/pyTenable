...
class ScoreApi(object):
    ...
    def api_profiles_profile_id_scores_get_with_http_info(self, x_api_key, profile_id, **kwargs):   
        ...
        if ('x_api_key' not in params or
            ...
            raise ValueError("Missing the required parameter `x_api_key` when calling `api_profiles_profile_id_scores_get`")   
        # verify the required parameter 'profile_id' is set
        if ('profile_id' not in params or
                params['profile_id'] is None):
            raise ValueError("Missing the required parameter `profile_id` when calling `api_profiles_profile_id_scores_get`")   
