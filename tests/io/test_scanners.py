...
def test_scanner_control_scans_notfounderror(api):
    ...
    with pytest.raises(NotFoundError):
        api.scanners.control_scan(1, 'c5e3e4c9-ee47-4fbc-9e1d-d6f39801f56c', 'stop')
...
def test_scanner_control_scans_permissionerror(stdapi):
    ...
    with pytest.raises(ForbiddenError):
        stdapi.scanners.control_scan(1, 'c5e3e4c9-ee47-4fbc-9e1d-d6f39801f56c', 'stop')
