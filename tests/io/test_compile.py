...
from tenable.io.credentials import CredentialsAPI, CredentialsIterator
...
from tenable.io.networks import NetworksAPI, NetworksIterator
from tenable.io.permissions import PermissionsAPI
from tenable.io.plugins import PluginIterator, PluginsAPI
...
from tenable.io.scans import ScanHistoryIterator, ScansAPI
