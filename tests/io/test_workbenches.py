...
def test_workbench_assets(api):
    ...
    if assets:
        ...
        check(a, 'id', 'uuid')
        check(a, 'installed_software', list)
        check(a, 'interfaces', list)
        ...
        check(a, 'last_scan_id', 'scanner-uuid', allow_none=True)
        check(a, 'last_scan_target', str, allow_none=True)
        check(a, 'last_schedule_id', str, allow_none=True)
