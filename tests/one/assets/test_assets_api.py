...
def asset_properties_response() -> dict[str, dict]:
    return {"asset_id": {"key": "asset_id", "readable_name": "Asset ID",
            ...
            "asset_class": {"key": "asset_class", "readable_name": "Asset Class",
                            "control": {"type": "STRING", "multiple_allowed": True,
            ...
            "asset_name": {"key": "asset_name", "readable_name": "Asset Name",
            ...
            "sources": {"key": "sources", "readable_name": "Sources",
                        "control": {"type": "STRING", "multiple_allowed": True,
                                    "selection": [{"name": "AWS Connector", "value": "AWS", "deprecated": True},
                                                  ...
                                                  {"name": "Tenable Vulnerability Management", "value": "T.IO",
                                                   "deprecated": False},
                                                  {"name": "Tenable OT Security", "value": "T.OT", "deprecated": False},
                                                  ...
                                                  {"name": "Rapid7 InsightVM", "value": "RAPID_7", "deprecated": True},
                                                  ...
                                                  {"name": "CrowdStrike Falcon", "value": "CROWDSTRIKE",
                                                   "deprecated": False},
                                                  {"name": "ServiceNow", "value": "SERVICE_NOW", "deprecated": False},
                                                  {"name": "Unclassified", "value": "UNCLASSIFIED",
                                                   "deprecated": False}]}, "operators": ["=", "!="], "sortable": True,
                        "filterable": True, "weight": 1.0,
                        "object_types": ["ACCOUNT", "APPLICATION", "CONTAINER", "GENERAL", "DEVICE", "GROUP", "STORAGE",
                                         "RESOURCE", "ROLE"],
            ...
            "created_at": {"key": "created_at", "readable_name": "Created Date",
            ...
            "first_observed_at": {"key": "first_observed_at", "readable_name": "First Observation Date",
            ...
            "acr": {"key": "acr", "readable_name": "ACR", "control": {"type": "NUMBER", "multiple_allowed": False,
            ...
            "is_licensed": {"key": "is_licensed", "readable_name": "Is Licensed",
