...
from tenable.exposuremanagement.attack_path.findings.findings import FindingsAPI
from tenable.exposuremanagement.attack_path.vectors.vectors import VectorsAPI
