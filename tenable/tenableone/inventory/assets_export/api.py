...
class AssetsExportAPI(APIEndpoint):
    def export(
        self,
    ...
    def status(self, export_id: str) -> ExportRequestStatus:
        ...
        Examples:
            >>> status = tenable_one.assets_export.status("export-123")
    ...
    def download(self, export_id: str, chunk_id: str) -> bytes:
        ...
        Examples:
            >>> data = tenable_one.assets_export.download("export-123", "0")
            >>> with open("assets_export.csv", "wb") as f:
            ...     f.write(data)
