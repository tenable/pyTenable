...
:tenableAD:`checker <CheckerObject>` API endpoints.

Methods available on ``tad.checker``:

.. rst-class:: hide-signature
.. autoclass:: CheckerApi

    .. automethod:: api_checkers_get
    .. automethod:: api_checkers_id_get
...
class CheckerApi(object):
    """
        Provide Checkers are the implementations of the state of the art of AD security
    """
    ...
    def api_checkers_get(self, x_api_key, **kwargs):
        ...
        >>> thread = api.api_checkers_get(self,x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_checkers_get_with_http_info(self,x_api_key, **kwargs)
        else:
            (data) = self.api_checkers_get_with_http_info(self,x_api_key, **kwargs)
            return data
    ...
    def api_checkers_id_get(self, x_api_key, id, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_checkers_id_get(self,x_api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_checkers_id_get_with_http_info(self,x_api_key, id, **kwargs)
        else:
            (data) = self.api_checkers_id_get_with_http_info(self,x_api_key, id, **kwargs)
            return data
    ...
    def api_checkers_id_get_with_http_info(self, x_api_key, id, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_checkers_id_get_with_http_info(self,x_api_key, id, async_req=True)
        >>> result = thread.get()
