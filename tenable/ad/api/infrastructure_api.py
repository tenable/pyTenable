...
class InfrastructureApi(object):
    ...
    def api_infrastructures_get(self, x_api_key, **kwargs):   
        ...
        >>> thread = api.api_infrastructures_get(x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_infrastructures_get_with_http_info(x_api_key, **kwargs)   
        else:
            (data) = self.api_infrastructures_get_with_http_info(x_api_key, **kwargs)   
            return data
    ...
    def api_infrastructures_get_with_http_info(self, x_api_key, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_infrastructures_get_with_http_info(x_api_key, async_req=True)
        >>> result = thread.get()
    ...
    def api_infrastructures_id_delete(self, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_infrastructures_id_delete(x_api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_infrastructures_id_delete_with_http_info(x_api_key, id, **kwargs)   
        else:
            (data) = self.api_infrastructures_id_delete_with_http_info(x_api_key, id, **kwargs)   
            return data
    ...
    def api_infrastructures_id_delete_with_http_info(self, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_infrastructures_id_delete_with_http_info(x_api_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def api_infrastructures_id_get(self, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_infrastructures_id_get(x_api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_infrastructures_id_get_with_http_info(x_api_key, id, **kwargs)   
        else:
            (data) = self.api_infrastructures_id_get_with_http_info(x_api_key, id, **kwargs)   
            return data
    ...
    def api_infrastructures_id_get_with_http_info(self, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_infrastructures_id_get_with_http_info(x_api_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def api_infrastructures_id_patch(self, body, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_infrastructures_id_patch(body, x_api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_infrastructures_id_patch_with_http_info(body, x_api_key, id, **kwargs)   
        else:
            (data) = self.api_infrastructures_id_patch_with_http_info(body, x_api_key, id, **kwargs)   
            return data
    ...
    def api_infrastructures_id_patch_with_http_info(self, body, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_infrastructures_id_patch_with_http_info(body, x_api_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def api_infrastructures_post(self, body, x_api_key, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_infrastructures_post(body, x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_infrastructures_post_with_http_info(body, x_api_key, **kwargs)   
        else:
            (data) = self.api_infrastructures_post_with_http_info(body, x_api_key, **kwargs)   
            return data
    ...
    def api_infrastructures_post_with_http_info(self, body, x_api_key, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_infrastructures_post_with_http_info(body, x_api_key, async_req=True)
        >>> result = thread.get()
