...
class AboutApi(object):
    ...
    def api_about_get(self, **kwargs):
        """Get about singleton.   

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_about_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_about_get_with_http_info(**kwargs)
        else:
            (data) = self.api_about_get_with_http_info(**kwargs)
            return data

    def api_about_get_with_http_info(self, **kwargs):
        """Get about singleton.   
