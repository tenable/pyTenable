...
class SyslogApi(object):
    ...
    def api_syslogs_get(self, x_api_key, **kwargs):   
        ...
        >>> thread = api.api_syslogs_get(x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_syslogs_get_with_http_info(x_api_key, **kwargs)   
        else:
            (data) = self.api_syslogs_get_with_http_info(x_api_key, **kwargs)   
            return data
    ...
    def api_syslogs_get_with_http_info(self, x_api_key, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_get_with_http_info(x_api_key, async_req=True)
        >>> result = thread.get()
    ...
    def api_syslogs_id_delete(self, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_id_delete(x_api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_syslogs_id_delete_with_http_info(x_api_key, id, **kwargs)   
        else:
            (data) = self.api_syslogs_id_delete_with_http_info(x_api_key, id, **kwargs)   
            return data
    ...
    def api_syslogs_id_delete_with_http_info(self, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_id_delete_with_http_info(x_api_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def api_syslogs_id_get(self, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_id_get(x_api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_syslogs_id_get_with_http_info(x_api_key, id, **kwargs)   
        else:
            (data) = self.api_syslogs_id_get_with_http_info(x_api_key, id, **kwargs)   
            return data
    ...
    def api_syslogs_id_get_with_http_info(self, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_id_get_with_http_info(x_api_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def api_syslogs_id_patch(self, body, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_id_patch(body, x_api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_syslogs_id_patch_with_http_info(body, x_api_key, id, **kwargs)   
        else:
            (data) = self.api_syslogs_id_patch_with_http_info(body, x_api_key, id, **kwargs)   
            return data
    ...
    def api_syslogs_id_patch_with_http_info(self, body, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_id_patch_with_http_info(body, x_api_key, id, async_req=True)
        >>> result = thread.get()
    ...
    def api_syslogs_post(self, body, x_api_key, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_post(body, x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_syslogs_post_with_http_info(body, x_api_key, **kwargs)   
        else:
            (data) = self.api_syslogs_post_with_http_info(body, x_api_key, **kwargs)   
            return data
    ...
    def api_syslogs_post_with_http_info(self, body, x_api_key, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_post_with_http_info(body, x_api_key, async_req=True)
        >>> result = thread.get()
    ...
    def api_syslogs_test_message_id_get(self, x_api_key, id, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_test_message_id_get(x_api_key, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_syslogs_test_message_id_get_with_http_info(x_api_key, id, **kwargs)   
        else:
            (data) = self.api_syslogs_test_message_id_get_with_http_info(x_api_key, id, **kwargs)   
            return data
    ...
    def api_syslogs_test_message_id_get_with_http_info(self, x_api_key, id, **kwargs):   
        ...
        if ('x_api_key' not in params or
                params['x_api_key'] is None):
            raise ValueError("Missing the required parameter `x_api_key` when calling `api_syslogs_test_message_id_get`")   
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
    ...
    def api_syslogs_test_message_post(self, body, x_api_key, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_test_message_post(body, x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_syslogs_test_message_post_with_http_info(body, x_api_key, **kwargs)   
        else:
            (data) = self.api_syslogs_test_message_post_with_http_info(body, x_api_key, **kwargs)   
            return data
    ...
    def api_syslogs_test_message_post_with_http_info(self, body, x_api_key, **kwargs):   
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_syslogs_test_message_post_with_http_info(body, x_api_key, async_req=True)
        >>> result = thread.get()
