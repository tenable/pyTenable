"""
SamlConfigurationApi
=============

The following methods allow for interaction into the Tenable.ad
:tenableAD:`saml_configuration <SamlConfigurationObject>` API endpoints.

Methods available on ``tad.saml_configuration``:

.. rst-class:: hide-signature
.. autoclass:: SAMLConfigurationApi

    .. automethod:: api_saml_configuration_generate_certificate_get
    .. automethod:: api_saml_configuration_get
    .. automethod:: api_saml_configuration_patch
...
class SAMLConfigurationApi(object):
    """
        Provide Authentification configuration with SAML
    """
    ...
    def api_saml_configuration_generate_certificate_get(self, x_api_key, **kwargs):
        ...
        >>> thread = api.api_saml_configuration_generate_certificate_get(self,x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.api_saml_configuration_generate_certificate_get_with_http_info(self,x_api_key, **kwargs)
        else:
            (data) = self.api_saml_configuration_generate_certificate_get_with_http_info(self,x_api_key, **kwargs)
            return data
    ...
    def api_saml_configuration_generate_certificate_get_with_http_info(self, x_api_key, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_saml_configuration_generate_certificate_get_with_http_info(self,x_api_key, async_req=True)
        >>> result = thread.get()
    ...
    def api_saml_configuration_get(self, x_api_key, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_saml_configuration_get(self,x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_saml_configuration_get_with_http_info(self,x_api_key, **kwargs)
        else:
            (data) = self.api_saml_configuration_get_with_http_info(self,x_api_key, **kwargs)
            return data
    ...
    def api_saml_configuration_get_with_http_info(self, x_api_key, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_saml_configuration_get_with_http_info(self,x_api_key, async_req=True)
        >>> result = thread.get()
    ...
    def api_saml_configuration_patch(self, body, x_api_key, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_saml_configuration_patch(self,body, x_api_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.api_saml_configuration_patch_with_http_info(self,body, x_api_key, **kwargs)
        else:
            (data) = self.api_saml_configuration_patch_with_http_info(self,body, x_api_key, **kwargs)
            return data
    ...
    def api_saml_configuration_patch_with_http_info(self, body, x_api_key, **kwargs):
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_saml_configuration_patch_with_http_info(self,body, x_api_key, async_req=True)
        >>> result = thread.get()
