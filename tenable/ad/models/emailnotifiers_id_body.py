...
class EmailnotifiersIdBody(object):
    ...
    def __init__(self, address=None, criticity_threshold=None, directories=None, description=None, checkers=None,
                 attack_types=None, profiles=None, input_type=None):
