...
class ApiLdapconfigurationBody(object):
    ...
    def __init__(self, enabled=None, url=None, search_user_dn=None, search_user_password=None, user_search_base=None, user_search_filter=None, allowed_groups=None):   
