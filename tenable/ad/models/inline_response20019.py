...
class InlineResponse20019(object):
    ...
    def __init__(self, id=None, directory_id=None, checker_id=None, profile_id=None, ad_object_id=None, reason_id=None,
                 resolved_event_id=None, resolved_at=None, created_event_id=None, event_date=None, ignore_until=None,
                 created_event_provider_id=None, resolved_event_provider_id=None, deviance_provider_id=None,
