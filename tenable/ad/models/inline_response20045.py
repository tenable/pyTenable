...
class InlineResponse20045(object):
    ...
    @property
    def roles(self):
        """Gets the roles of this InlineResponse20045.   


        :return: The roles of this InlineResponse20045.   
        :rtype: list[int]
        """
        return self._roles
    ...
    def roles(self, roles):
        """Sets the roles of this InlineResponse20045.


        :param roles: The roles of this InlineResponse20045.   
        :type: list[int]
        """
        if roles is None:
