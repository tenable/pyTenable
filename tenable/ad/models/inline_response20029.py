...
class InlineResponse20029(object):
    ...
    def __init__(self, customer_name=None, max_active_user_count=None, current_active_user_count=None,
                 expiration_date_utc=None, in_app_eula=None, type=None, features=None):
