...
class InlineResponse20039(object):
    ...
    def __init__(self, id=None, ip=None, port=None, protocol=None, tls=None, criticity_threshold=None, description=None,
                 filter_expression=None, input_type=None, directories=None, checkers=None, attack_types=None,
                 profiles=None, should_notify_on_initial_full_security_check=None):
