...
class InlineResponse20036(object):
    ...
    def __init__(self, enabled=None, provider_login_url=None, encryption_certificate=None, signature_certificate=None,
                 service_provider_url=None, assert_endpoint=None, activate_created_users=None, allowed_groups=None):
