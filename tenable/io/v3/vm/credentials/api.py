    ...
    def search(self,
        ...
        Args:
            ...
            filter (tuple, Dict, optional):
                ...
                time. Please refer to the respective definition endpoint for
                more information.
                For Credentaials endpoint respective definitions endpoint
                is not available and will be implemented in future which
                would return the filter details for the endpoint.
