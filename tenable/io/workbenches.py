...
class WorkbenchesAPI(TIOEndpoint):
    ...
    def asset_delete(self, asset_uuid: str) -> None:
        '''
        Deletes the asset.
    ...
    def export(
        ...
        if 'format' in kw:
            ...
            if kw['format'] not in ['nessus', ]:
                ...
                if 'chapters' not in kw:
                    ...
                    params['chapter'] = ';'.join(self._check(
        ...
        # File id for the job.
        fid = self._api.get(
            'workbenches/export', params=params).json()['file']
