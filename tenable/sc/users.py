...
`User <https://docs.tenable.com/sccv/api/User.html>`_ API.  These 
...
class UserAPI(SCEndpoint):
    ...
    def create(self, username, password, role, **kw):
        ...
        + `user: create <https://docs.tenable.com/sccv/api/User.html#user_POST>`_
    ...
    def details(self, id, fields=None):
        ...
        + `user: details <https://docs.tenable.com/sccv/api/User.html#UserRESTReference-/user/{id}>`_
    ...
    def edit(self, id, **kw):
        ...
        + `user: edit <https://docs.tenable.com/sccv/api/User.html#user_id_PATCH>`_
    ...
    def delete(self, id):
        ...
        + `user: delete <https://docs.tenable.com/sccv/api/User.html#user_id_DELETE>`_
