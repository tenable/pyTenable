...
class TenableSC(APIPlatform):  # noqa PLR0904
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if host:
            warnings.warn(
                'The "host", "port", and "scheme" parameters are '
    ...
    def _key_auth(self, access_key, secret_key):
        ...
        if not self.version or VersionInfo.parse(self.version).match('>=5.13.0'):
    ...
    def _session_auth(self, username, password):
        ...
        """
        warnings.warn(
            'Session based authentication to Security Center will be removed'
    ...
    def login(self, username=None, password=None, access_key=None, secret_key=None):
        """
        ...
        """
        warnings.warn(
            'Use of the login method is deprecated and will be removed in'
    ...
    def hosts(self):
        """
        The interface object for the
        :doc:`Tenable Security Center Hosts APIs <hosts>`.
        """
