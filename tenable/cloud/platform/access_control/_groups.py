...
class AccessControlGroupAPI(APIEndpoint):
    ...
    def update(self, group_id: int | UUID | str, name: str) -> AccessControlGroup:
        """
    ...
    def delete(self, group_id: int | UUID | str) -> None:
        """
    ...
    def get_users(self, group_id: int | UUID | str) -> list[AccessControlUser]:
        """
    ...
    def add_user(self, group_id: int | UUID | str, user_id: int | UUID | str) -> None:
        """
    ...
    def remove_user(
        self, group_id: int | UUID | str, user_id: int | UUID | str
    ) -> None:
        """
...
class AsyncAccessControlGroupAPI(AsyncAPIEndpoint):
    ...
    async def update(self, group_id: int | UUID | str, name: str) -> AccessControlGroup:
        """
        Updates the specified group
    ...
    async def delete(self, group_id: int | UUID | str) -> None:
        """
        Deletes the specified group
    ...
    async def get_users(self, group_id: int | UUID | str) -> list[AccessControlUser]:
        """
        Lists the users that are members of the group
